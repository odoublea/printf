This repo holds the source code for printf rebuild in C language

# printf
A simple printf function built by Abdulqudus Oladega and Oladipupo Ajabi for Alx software Engineering School.

# Welcome
Rebuild of the standard printf function in C. Our project required a function capable of printing with the %d, %c, %s, and %% format specifiers to standard output. printf returns the number of characters printed (excluding the null byte at the end of strings). Flag characters, field width, precision, and length were not considered
...
# Authors
Abdulqudus Oladega-@odoublea and Oladipupo Ajabi-@AjabiOladipupo
